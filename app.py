...
# --- IDENTIDAD VISUAL INTELIGENTE (ADAPTATIVA A MODOS CLARO/OSCURO) ---
st.markdown("""
    <style>
    ...
    /* Título Principal - Usa el color de texto del sistema (Garantiza visibilidad) */
    .titulo-principal {
        text-align: center;
    ...
    /* Subtítulo de Sección - Un azul cian intermedio que resalta tanto en fondo blanco como oscuro */
    .subtitulo-principal {
        text-align: center;
    ...
    /* Botón de Acción con alto contraste en cualquier fondo */
